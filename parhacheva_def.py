...
def mariya_def():
    ...
    data.columns = ['Ид пассажира', 'Спасен (да/нет)', 'Класс каюты', 'ФИО', 'Пол', 'Возраст',
                    'Количество родственников на борту', 'Количество родителей/детей на борту',
                    'Номер билета', 'Плата за проезд', 'Каюта', 'Порт посадки']
